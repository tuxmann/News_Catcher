...
ARTICLE_STRIP_RULES_FILE = Path(
    os.environ.get("ARTICLE_STRIP_RULES_FILE", "data/article_strip_rules.json")
)
if not ARTICLE_STRIP_RULES_FILE.is_absolute():
    ARTICLE_STRIP_RULES_FILE = PROJECT_ROOT / ARTICLE_STRIP_RULES_FILE
